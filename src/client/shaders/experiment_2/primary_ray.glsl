...
layout (rg8ui, binding = 0) uniform restrict writeonly uimage2D out_voxel;
layout (rgb8, binding = 0) uniform restrict writeonly image2D out_position; // will include the normal later :)
